...
import br.com.johncobain.utils.SwipeToDeleteContainer
...
fun ExpensesTotalHeader(total: Double) {
    Card(shape = RoundedCornerShape(30), backgroundColor = Color.Black, elevation = 5.dp) {
        Box(
            ...
            Text(modifier = Modifier.align(Alignment.CenterEnd), text = "BRL", color = Color.Gray)
        }
    }
}
        ...
        Row(
            ...
            Surface(
                ...
                Image(
                    ...
                    contentDescription = "Image Expense Item Icon"
                )
            }
