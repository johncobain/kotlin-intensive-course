...
class ExampleText {
    ...
    fun expense_model_list_test(){
        ...
        val expense = Expense(id = 1, amount = 4.5, category = ExpenseCategory.CAR, description = "Gasoline")
    ...
    fun expense_model_param_test_success(){
        ...
        val expense = Expense(id = 1, amount = 4.5, category = ExpenseCategory.OTHER, description = "Gasoline")
        val expense2 = Expense(id = 2, amount = 14.5, category = ExpenseCategory.OTHER, description = "Cleaning")
